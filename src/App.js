...
const STATIC_CHARGERS = [
  ...
  {"id":"esb_12","lat":53.382607,"lon":-6.3810649,"address":"Tesco Blanchardstown, Roselawn Shopping Centre","operator":"ESB eCars","num_chargers":1},
  ...
  {"id":"esb_21","lat":53.3459526,"lon":-6.2383946,"address":"Sir John Rogersons Quay, Dublin 2","operator":"ESB eCars","num_chargers":2},
  ...
  {"id":"esb_40","lat":53.354892,"lon":-6.287405,"address":"St. Josephs Road, Dublin 7","operator":"ESB eCars","num_chargers":1},
  ...
  {"id":"esb_76","lat":53.349266,"lon":-6.452681,"address":"Lucan Shopping Centre, Newcastle Road","operator":"ESB eCars","num_chargers":1},
  ...
  {"id":"esb_79","lat":53.451232,"lon":-6.15157,"address":"James Terrace, Malahide","operator":"ESB eCars","num_chargers":1},
  ...
  {"id":"esb_86","lat":53.4539168,"lon":-6.2213287,"address":"Swords Pavilions Shopping Centre, Swords","operator":"ESB eCars","num_chargers":5},
  ...
  {"id":"dlr_12","lat":53.2527750,"lon":-6.1698130,"address":"Carrickmines Luas Park and Ride","operator":"ESB","num_chargers":4},
  ...
  {"id":"dlr_18","lat":53.3049123,"lon":-6.2064813,"address":"Radisson Blu St Helens, Stillorgan Road","operator":"ESB","num_chargers":2},
  {"id":"dlr_19","lat":53.2833000,"lon":-6.1659200,"address":"Windsor Motors Deansgrange","operator":"Other","num_chargers":1},
  ...
  {"id":"dlr_25","lat":53.2879188,"lon":-6.2356596,"address":"Overend Way, Dublin 14","operator":"Tesla","num_chargers":2},
...
function App() {
  const [chargers, setChargers] = useState(STATIC_CHARGERS);
  ...
  return (
    <div style={{ height: '100vh', width: '100%', display: 'flex', flexDirection: 'column' }}>
      <div style={{ height: '55px', background: '#1a252f', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 20px', zIndex: 1000 }}>
        <h2 style={{ margin: 0, fontSize: '16px', fontWeight: '500' }}>
          ⚡ EcoCharge Dublin: EV Infrastructure Optimization Dashboard
        </h2>
        <span style={{ fontSize: '11px', color: dataSource === 'api' ? '#2ecc71' : '#f39c12' }}>
          {dataSource === 'api' ? '🟢 Live API Data' : '🟡 Static Data'}
        </span>
      </div>
